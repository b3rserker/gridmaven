 ...
 */
public class HelloWorldJob extends AbstractProject<HelloWorldJob,HelloWorldRun> implements TopLevelItem{
    ...
    public HelloWorldJob(ItemGroup itemGroup, String name) {
    ...
    @Override
    protected Class<HelloWorldRun> getBuildClass() {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    public static final class DescriptorImpl extends AbstractProjectDescriptor {
        ...
        public TopLevelItem newInstance(ItemGroup paramItemGroup, String paramString) {
            return new HelloWorldJob(Hudson.getInstance(), paramString);
        }
    }
